...
public class WoodCraftingJournalIntegration extends BaseComponentSystem {
    ...
    private final String wasChapterId = "WoodAndStoneCrafting";
    ...
    public void preBegin() {
        ...
        chapterHandler.registerJournalEntry("Stone",
                Arrays.asList(
                        ...
                        createTextParagraph("Stones are essential for making most tools. Digging the ground might be " +
                                "a good way to find stones." +
        ...
        chapterHandler.registerJournalEntry("ToolStone",
                Arrays.asList(
                        ...
                        createTextParagraph("Now that I have stones, I can use two stones to make a Tool Stone which " +
                                "will allow me to build other equipment like an axe " +
                                "(press N to open crafting window)."),
                        new ImageParagraph(new Prefab[]{toolStoneItem}, null),
                        createTextParagraph("By using the Tool Stone on another stone I should be able to make an " +
                                "Axe-Hammer Head."),
        ...
        chapterHandler.registerJournalEntry("AxeHammer",
                Arrays.asList(
                        ...
                        createTextParagraph("Now that I have an axe-hammer head, all I need is a stick for the handle" +
                                " and a twig to tie it together. " +
        ...
        chapterHandler.registerJournalEntry("AxeHammerReceived",
                Arrays.asList(
                        ...
                        createTextParagraph(("Excellent! I got the Axe-Hammer. I should be able to cut some of the " +
                                "trees with it. " +
                                "I can also use it to dig stone to get some more Stones for my crafting. It's not " +
                                "perfect but will have to do until I get my hands on a " +
        ...
        chapterHandler.registerJournalEntry("Logs",
                Arrays.asList(
                        ...
                        createTextParagraph(("These logs are big, there is no way I can handle them with my hands. " +
                                "I have to build a place where I can work on them. I should place two of the logs on " +
                                "the ground next to each other " +
                                "and then place my Axe on it (right-click your Axe-Hammer on the top face of one of " +
                                "the logs)."))
                ));
        ...
        chapterHandler.registerJournalEntry("WoodCraftingStation",
                Arrays.asList(
                        ...
                        createTextParagraph(("Now I can work on the logs (to open the interface, press 'E' while " +
                                "pointing " +
                                "on the station).<l><l>I can store some ingredients in the top-left corner of the " +
                                "station and my axe in the bottom-center " +
                                "of the station. It's very crude and won't let me do much, but once I gather 10 Wood " +
                                "Planks I should be able to upgrade it. " +
                                "(to upgrade place the ingredients into bottom-left corner of the interface and press" +
                                " the 'Upgrade' button)"))
                ));
        ...
        chapterHandler.registerJournalEntry("WoodCraftingStationUpgraded",
                Arrays.asList(
                        ...
                        createTextParagraph(("Finally I can make something more useful than just planks. " +
                                "Not only that, but I can also create planks more efficiently! Quality of the " +
                                "workspace speaks for itself.<l><l>" +
                                "But I still can't make any tools. Hard to make it just out of wood, haha. I should " +
                                "probably find a good place " +
                                "to work on stone materials. I should make two tables using planks and sticks" +
                                ".<l><l>Once I get the tables I should place them " +
                                "on the ground next to each other and put my Axe-Hammer on top of one of them (same " +
                                "as before)."))
                ));
    ...
    public void playerPickedUpItem(InventorySlotChangedEvent event, EntityRef character,
        ...
        CraftInHandIngredientComponent craftInHandIngredientComponent =
                event.getNewItem().getComponent(CraftInHandIngredientComponent.class);
